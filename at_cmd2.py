...
while True:
    ...
    if hour ==  '11':
        ...
        # vd: 'C:/abc'
        path_input_move = r"C:\Users\AICCSX\Desktop\Hieu\C2"


        # tên classes
        # vd: ['loi1','loi2']
        myclasses5 = ['nut_me','divat','me','namcham','namchamcao','nut','tray_bac_truc']



        # đường dẫn lưu kết quả
        # vd: 'C:/save'
        path_save = r"C:\Users\AICCSX\Desktop\Hieu\model_c2"


        # tên file
        # vd: 'abc'
        name_save = "A47_A19_C2_01102022"
