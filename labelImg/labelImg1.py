...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        save_image = action(get_str('save'), self.save_image,
                      'p', 'save', get_str('saveDetail'))
        ...
        self.actions.beginner = (
            open, open_dir, change_save_dir, open_next_image, open_prev_image, verify, save,save_image, save_format, None, create, copy, delete, None,
            zoom_in, zoom, zoom_out, fit_window, fit_width)

        self.actions.advanced = (
            open, open_dir, change_save_dir, open_next_image, open_prev_image, save,save_image, save_format, None,
    ...
    def save_image(self, _value=False):

        if self.file_path:
            image_file_name = os.path.basename(self.file_path)
            saved_path = os.path.join(ustr(self.default_save_dir), image_file_name)

            shutil.copyfile(saved_path, 'D:/TEST_NG/'+ image_file_name)
